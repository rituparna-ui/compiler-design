...
{
  "$end", "error", "$undefined", "NUM", "ID", "INT", "DOUBLE", "'+'",
  "'-'", "'*'", "'/'", "'\\n'", "'('", "')'", "$accept", "start", "expr",
...
{
       3,     0,     1,    13,    11,    12,     0,     0,     6,     9,
       0,     0,     0,     2,     0,     0,    10,     4,     5,     7,
       8
};
...
{
       2,     3,     4,     5,     3,     4,     5,    14,    15,     6,
      11,    12,     6,    11,    12,    10,    16,    13,    17,    18,
       0,     0,    19,    20
};

static const yytype_int8 yycheck[] =
{
       0,     4,     5,     6,     4,     5,     6,     9,    10,    12,
       7,     8,    12,     7,     8,     6,    13,    11,    11,    12,
      -1,    -1,    14,    15
};
...
{
       0,    15,     0,     4,     5,     6,    12,    16,    17,    18,
      16,     7,     8,    11,     9,    10,    13,    17,    17,    18,
      18
};
...
yyreduce:
  ...
  case 2:
#line 45 "part1.y"
                                        { printf("The type of the resulting output: %s\n",typeChecker((yyvsp[-1].ptr))); }
#line 1334 "part1.tab.c"
    break;

  case 3:
#line 46 "part1.y"
                                        { }
#line 1340 "part1.tab.c"
    break;

  case 4:
#line 50 "part1.y"
                                        { (yyval.ptr) = createNode((yyvsp[-2].ptr), (yyvsp[0].ptr), "+"); }
#line 1346 "part1.tab.c"
    break;

  case 5:
#line 51 "part1.y"
                                        { (yyval.ptr) = createNode((yyvsp[-2].ptr), (yyvsp[0].ptr), "-"); }
#line 1352 "part1.tab.c"
    break;

  case 6:
#line 52 "part1.y"
                                        { (yyval.ptr) = (yyvsp[0].ptr); }
#line 1358 "part1.tab.c"
    break;

  case 7:
#line 56 "part1.y"
                                        { (yyval.ptr) = createNode((yyvsp[-2].ptr), (yyvsp[0].ptr), "*"); }
#line 1364 "part1.tab.c"
    break;

  case 8:
#line 57 "part1.y"
                                        { (yyval.ptr) = createNode((yyvsp[-2].ptr), (yyvsp[0].ptr), "/"); }
#line 1370 "part1.tab.c"
    break;

  case 9:
#line 58 "part1.y"
                                        { (yyval.ptr) = (yyvsp[0].ptr); }
#line 1376 "part1.tab.c"
    break;

  case 10:
#line 62 "part1.y"
                                        { (yyval.ptr) = (yyvsp[-1].ptr); }
#line 1382 "part1.tab.c"
    break;

  case 11:
#line 63 "part1.y"
                                        { (yyval.ptr) = createNode(0,0,(yyvsp[0].str)); insertSym((yyvsp[0].str),"int"); }
#line 1388 "part1.tab.c"
    break;

  case 12:
#line 64 "part1.y"
                                        { (yyval.ptr) = createNode(0,0,(yyvsp[0].str)); insertSym((yyvsp[0].str),"double"); }
#line 1394 "part1.tab.c"
    break;

  case 13:
#line 65 "part1.y"
                                        { (yyval.ptr) = createNode(0,0,(yyvsp[0].str)); insertSym((yyvsp[0].str),"string"); }
#line 1400 "part1.tab.c"
    break;


#line 1404 "part1.tab.c"
