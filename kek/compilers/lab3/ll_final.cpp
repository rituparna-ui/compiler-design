...
vector<string> nonterm_userdef={"S","A","B"};
vector<string> term_userdef={"a","b"};
...
int main() {
    ...
    vector<string> rule1={"Ab", "Ba","#" };
    vector<string> rule2={"aS" , "bAA" };
    vector<string> rule3={"b" };

    rules.insert(pair<string,vector<string>> ("S",rule1));
    rules.insert(pair<string,vector<string>> ("A",rule2));
    rules.insert(pair<string,vector<string>> ("B",rule3));
